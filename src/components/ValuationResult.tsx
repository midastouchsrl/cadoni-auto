  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card p-5 opacity-0 animate-fade-in-up animate-delay-150 border-l-4 border-l-teal-500/50">
        <h3 className="text-sm font-medium text-slate-200 mb-5 flex items-center gap-2">
        ...
        <div className="relative py-4">
          ...
          <div className="h-2.5 bg-slate-700/50 rounded-full relative">
            {/* Highlighted band - probable range */}
            <div
              className="absolute h-full bg-gradient-to-r from-teal-600/40 via-teal-400/70 to-teal-600/40 rounded-full"
              style={{
                left: `${rangeMinPos}%`,
            ...
            <div
              className="absolute top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-teal-400 rounded-full border-2 border-slate-800 shadow-lg shadow-teal-500/30"
      ...
      <div className="glass-card p-5 opacity-0 animate-fade-in-up animate-delay-250 border-l-4 border-l-emerald-500/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-slate-800/50 border border-emerald-500/20 hover:border-emerald-500/40 transition-colors">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-white">Mercato diretto</span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-slate-800/50 border border-blue-500/20 hover:border-blue-500/40 transition-colors">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium text-white">Canale professionale</span>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-slate-300">Mercato diretto</span>
            ...
            <div className="h-3 bg-slate-700/50 rounded-full relative overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-emerald-600/50 to-emerald-400/70 rounded-full"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-slate-300">Canale professionale</span>
              <span className="text-xs font-medium text-blue-400">{formatPrice(professionalChannel)}</span>
            </div>
            <div className="h-3 bg-slate-700/50 rounded-full relative overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-blue-600/50 to-blue-400/70 rounded-full"
      ...
      <div className="glass-card p-5 opacity-0 animate-fade-in-up animate-delay-350 border-l-4 border-l-amber-500/50">
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <span className="text-sm text-slate-300">Per confrontare offerte o proposte ricevute</span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-5 h-5 rounded-full bg-teal-500/15 flex items-center justify-center flex-shrink-0 mt-0.5">
              <svg className="w-3 h-3 text-teal-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <span className="text-sm text-slate-300">Per definire un prezzo coerente con il mercato</span>
          </li>
          <li className="flex items-start gap-3">
            <div className="w-5 h-5 rounded-full bg-teal-500/15 flex items-center justify-center flex-shrink-0 mt-0.5">
              <svg className="w-3 h-3 text-teal-400" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <span className="text-sm text-slate-300">Per scegliere il canale di vendita più adatto alle tue esigenze</span>
          </li>
        </ul>
      </div>
      ...
      {/* ============================================
          DISCLAIMER
          ============================================ */}
      <div className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50 opacity-0 animate-fade-in-up animate-delay-450">
